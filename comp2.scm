...
;CISC function for getting the last
...
(define define_support_methods
        (sa make-list print_memory print-stack get_last_bucket compare_strings copy_string))
...
CMP(FPARG(1), IMM(" par-len "));
JUMP_EQ("jump_label");
printf(\"at " jump_label "\");
...
(define code-gen-applic
        (lambda (pe params env)
                ...
                (sa
                        ...
                        ;"print_stack(\"normal applic just before function call\");\n"
